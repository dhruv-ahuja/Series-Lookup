    ...
    def compare(self, scraped):
        ...
        for num, data in zip(scraped, self.local_data):
            ...
            if num > int(s_count):
                ...
                toast.show_toast(
                    "New Season Alert!",
                    f"The show {name} has received a new season!",
        ...
        toast.show_toast(
            "Overview", f"{count} updates", icon_path="Untitled.ico", duration=None
        ) if count else toast.show_toast(
            "Overview", f"No updates", icon_path="Untitled.ico", duration=None
        )
